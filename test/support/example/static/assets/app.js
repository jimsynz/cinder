(() => {
  ...
  // js/components/cinder/components/link.js
  var Cinder$Components$Link = class extends CinderComponent {
    constructor(element, cinder) {
      super(element, cinder);
      this.registerEvent("click", function(event) {
        let uri = this.getAttribute("href");
        if (uri == null ? void 0 : uri.startsWith("/")) {
  ...
  // js/cinder_components.js
  var cinder_components_default = { Cinder$Components$Link };

  // js/app.js
  new Cinder(cinder_components_default);
})();
